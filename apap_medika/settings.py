...
WSGI_APPLICATION = 'apap_medika.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'ApapMedika Hospital Management System API',
    'DESCRIPTION': 'Comprehensive API for managing hospital operations including appointments, patients, doctors, prescriptions, insurance, and billing.',
    'VERSION': '1.0.0',
